...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('img/zen.png') }}" rel="icon" type="image/png">
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #24416d;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-10">Selamat Datang, {{ Auth::user()->role }}</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; abdi_2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
